              ...
              <div class="col-xs-12">
                <div class="bradcaump__inner">
                  <nav class="bradcaump-inner">
                    <span class="breadcrumb-item active">The Fashion Directory</span>
                  </nav>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-9 col-lg-push-3 col-md-9 col-md-push-3 col-sm-12 col-xs-12">
              ...
              <div class="row">
                <div class="col-xs-12 text-center" style="margin-top: 50px;">
                  <a class="btn btn-round btn-success" href="#">Show More</a>
                </div>
              </div>
              ...
              <div class="htc__product__leftsidebar">
                ...
                <div class="htc__category">
                  ...
                  <ul class="ht__cat__list">
                    ...
                    <li><a href="#">Urban Street</a></li>
                    <li><a href="#">Couture</a></li>
                    <li><a href="#">Haute Couture</a></li>
                    <li><a href="#">Bridal/Evening Dresses</a></li>
                    <li><a href="#">Male suits/Tuxedos</a></li>
                    <li><a href="#">Workwear</a></li>
                    <li><a href="#">Uniforms (School or Staff)</a></li>
                ...
                <div class="ht__pro__size">
                  <h4 class="title__line--4">Option</h4>
